...
pip --no-cache-dir install 'https://repo.hops.works/master/pydoop/pydoop-2.0.0.tar.gz'

# Install PydoopFSSpec
git clone https://github.com/pwang697/PydoopFSSpec.git
pushd PydoopFSSpec
python setup.py sdist bdist_wheel
popd
pip --no-cache-dir install PydoopFSSpec/dist/pydoopfsspec-0.1.0-py3-none-any.whl
sudo rm -rf PydoopFSSpec
